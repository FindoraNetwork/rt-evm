...
use crate::precompiles::{
    blake2_f::Blake2F, ec_add::EcAdd, ec_mul::EcMul, ec_pairing::EcPairing,
    ecrecover::EcRecover, identity::Identity, modexp::ModExp, ripemd160::Ripemd160,
    sha256::Sha256,
};
...
pub(crate) fn read_fr(input: &[u8], start: usize) -> Result<Fr, PrecompileFailure> {
    ...
    Fr::from_slice(&input[start..(start + 32)])
        .map_err(|_| err!(_, "Invalid field element"))
}
